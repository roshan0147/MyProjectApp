...
public class WhUserTypeUtil {
	...
	public void generatePieChart(String path,List<Object[]> data)
	{
		...
		JFreeChart chart=ChartFactory.createPieChart("WhUserType Pie Chart", dataset,true,false,false);
	    try {
	...
	public void generateBarChart(String path,List<Object[]> data)
	{
		...
		JFreeChart chart=
				ChartFactory.createBarChart("WhUserType Bar Chart","Types","COUNT", dataset);
	          try {
